            ...
            <div class="card-body">
                <form method="POST" action="{{ route('products.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="unit_price" id="unit_price" class="form-control @error('unit_price') is-invalid @enderror" value="{{ old('unit_price') }}" step="0.01" min="0.01" required>
                        @error('unit_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
