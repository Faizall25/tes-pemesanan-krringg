...
<head>
    ...
    <title>Login - Kriingg Management System</title>
    <!-- Tailwind CSS -->
                ...
                <div class="card border-0 shadow-lg rounded-lg overflow-hidden">
                    <div class="card-body p-6">
                        ...
                        <div class="text-center mt-4">
                            <p class="text-sm text-gray-600">Don't have an account? <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-800">Create one!</a></p>
                        </div>
                    </div>
                </div>
            </div>
